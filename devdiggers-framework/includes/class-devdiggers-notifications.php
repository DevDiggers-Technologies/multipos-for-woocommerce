		...
		public function render_admin_notices() {
			...
			foreach ( $notifications as $notification ) {
				...
				if ( $notification['dismissible'] ) {
					...
					$script_path = DDFW_FILE . 'assets/js/notifications.js';

					wp_enqueue_script( 'devdiggers-notifications', DDFW_URL . 'assets/js/notifications.js', [], filemtime( $script_path ), true );
				}
				// Append UTMs
				$id = $notification['id'];
				...
				?>
				<div class="<?php echo esc_attr( $class ); ?>" data-id="<?php echo esc_attr( $notification['id'] ); ?>" data-slug="<?php echo esc_attr( $this->config['plugin_slug'] ); ?>" data-nonce="<?php echo esc_attr( wp_create_nonce( 'devdiggers_dismiss_notification' ) ); ?>">
					<p>
