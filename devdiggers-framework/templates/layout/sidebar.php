...
<div class="ddfw-template-container">
	...
	if ( ! empty( $tabs ) && is_array( $tabs ) ) {
		...
		<!-- Mobile settings sidebar toggle button (FAB) -->
		<button class="ddfw-mobile-settings-toggle" type="button" aria-label="<?php esc_attr_e( 'Toggle Settings', 'devdiggers-multipos-for-woocommerce' ); ?>">
		...
		<div class="ddfw-mobile-settings-overlay"></div>

		<nav class="ddfw-left-tab-wrapper">
			<!-- Mobile settings sidebar close button -->
			<button class="ddfw-mobile-settings-close" type="button" aria-label="<?php esc_attr_e( 'Close Settings', 'devdiggers-multipos-for-woocommerce' ); ?>">
