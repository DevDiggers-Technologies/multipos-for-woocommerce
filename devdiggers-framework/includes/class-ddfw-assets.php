		...
		public function register_styles_and_scripts() {
			...
			if ( ! empty( $_GET['page'] ) && in_array( $_GET['page'], [ 'devdiggers-plugins', 'devdiggers-extensions' ], true ) ) {
				...
				wp_localize_script(
					...
					[
						...
						'i18n' => [
							'subscribing'         => esc_html__( 'Subscribing...', 'devdiggers-multipos-for-woocommerce' ),
							'subscribe'           => esc_html__( 'Subscribe', 'devdiggers-multipos-for-woocommerce' ),
							'subscriptionSuccess' => esc_html__( 'Thank you for subscribing!', 'devdiggers-multipos-for-woocommerce' ),
							'subscriptionError'   => esc_html__( 'An error occurred. Please try again.', 'devdiggers-multipos-for-woocommerce' ),
						],
					]
				);
			}
			...
			wp_localize_script(
				...
				[
					...
					'i18n' => [
						'selectImage'         => esc_html__( 'Select Image', 'devdiggers-multipos-for-woocommerce' ),
						'useImage'            => esc_html__( 'Use Image', 'devdiggers-multipos-for-woocommerce' ),
						...
						'deleteConfirm'       => esc_html__( 'Are you sure you want to delete?', 'devdiggers-multipos-for-woocommerce' ),
					],
					'site_url'          => site_url(),
