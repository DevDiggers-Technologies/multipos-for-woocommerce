...
// phpcs:disable WordPress.WP.AlternativeFunctions.file_system_operations_fopen, WordPress.WP.AlternativeFunctions.file_system_operations_fclose, WordPress.WP.AlternativeFunctions.file_system_operations_fwrite, WordPress.WP.AlternativeFunctions.unlink_unlink -- CLI-only build utility, not runtime plugin code.
 ...
 * @return array
 */
function ddwcpos_parse_pot( $file_name ) {
...
$originals_1 = ddwcpos_parse_pot( $argv[1] );
$originals_2 = ddwcpos_parse_pot( $argv[2] );
